...
//   double _calculateStudentGrade(Map<String, dynamic> student) {
//     // Get the list of assignments
//     final assignments = student['completed'] ?? [];
...
//       final maxScore = assignment['maxScore'] ?? 1; // Avoid division by zero
//       if (maxScore > 0) {
//         totalGrade += score / maxScore; // Calculate the grade as score/maxScore
//       }
//     }

//     // Calculate the average grade
//     return totalGrade / assignments.length * 100; // Convert to percentage
//   }
...
//                             ? (student['completed'] / student['total'])
//                             : 0.0;
//                         final studentGrade = _calculateStudentGrade(student);
...
//                                     ),
//                                     Text(
//                                       'Average Grade: ${studentGrade.toStringAsFixed(1)}%',
//                                       style: const TextStyle(
//                                         fontSize: 14,
//                                         color: Colors.grey,
//                                       ),

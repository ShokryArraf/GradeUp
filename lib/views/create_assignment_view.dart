...
class CreateAssignmentViewState extends State<CreateAssignmentView> {
  ...
  // List<int> get _grades => widget.teacher.teachingGrades;
...
// Retrieve all grades the teacher teaches (flattened list of all grades)
  List<int> get _grades => widget.teacher.lessonGradeMap.values
      .expand((grades) => grades)
      .toSet()
      .toList(); // Ensure unique grades
          ...
          child: Column(
            ...
            children: [
              ...
              if (_grades.isNotEmpty)
                ...
                const Center(
                  child: Text(
                    'No grades available. Please configure grades for this teacher.',
                    style: TextStyle(color: Colors.red, fontSize: 16),
                    textAlign: TextAlign.center,
                  ),
                ),

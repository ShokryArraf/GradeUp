...
//       _questionsController; // For comma-separated questions
...
//     _lessonController = TextEditingController(text: widget.lessonId);
...
//         .toList();
//     final lessonId = _lessonController.text.trim();
...
//         const SnackBar(
//             content:
//                 Text('Title, description, lesson, and grade are required.')),
//       );
//       return;
//     }

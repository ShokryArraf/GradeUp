...
import 'package:grade_up/emergency/emergency_instructions.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              buildDashboardCard(
                  Icons.emergency,
                  'Emergency Instructions in hebrew/הוראות חירום',
                  const Color.fromARGB(255, 175, 76, 137), () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const EmergencyInstruction(),
                  ),
                );
              }),
            ],
